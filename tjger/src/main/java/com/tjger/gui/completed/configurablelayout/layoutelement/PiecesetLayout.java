...
public class PiecesetLayout extends LayoutGameElementSet {
     ...
     */
    public PiecesetLayout(String xPos, String yPos, String percentSize, AreaLayout area, int xSpacing, int ySpacing, String orientation, int wrapThreshold) {
        super(ConstantValue.CONFIG_PIECESET, xPos, yPos, percentSize, area, xSpacing, ySpacing, orientation, wrapThreshold);
    }
}
