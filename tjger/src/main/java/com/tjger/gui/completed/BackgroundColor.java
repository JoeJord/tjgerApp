...
public class BackgroundColor extends Part {
    ...
    public BackgroundColor(Color defaultColor, boolean hidden) {
        super(ConstantValue.CONFIG_BACKCOLOR, "background_color", null, hidden);
    ...
    public boolean equals(Object o2) {
    	return (HGBaseTools.equalClass(this, o2) 
    			&& HGBaseTools.equalObject(getActiveColor(), ((BackgroundColor) o2).getActiveColor()));
    }
