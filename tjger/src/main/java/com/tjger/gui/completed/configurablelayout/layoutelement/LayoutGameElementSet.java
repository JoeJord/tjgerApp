...
public class LayoutGameElementSet extends LayoutGameElement {
     ...
     * @param angle         The angle with which the elements in the set should be painted.
     ...
     */
    public LayoutGameElementSet(String type, String xPos, String yPos, String percentSize, double angle, AreaLayout area, int xSpacing, int ySpacing, String orientation, int wrapThreshold) {
